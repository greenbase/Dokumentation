...
Der eröffnete Usecase beruft sich auf allgemeinen Konzepten von PdM. Darüberhinaus gehend ist es sinnvoll den Usecase in den Kontext der praktischen Bahntechnik zu stellen. Insbesondere eine Diskusion über den tatsächlichen Bedarf, als auch eine Darstellungen des Praxisumfelds ist für eine Bewertung des Usecases zuträglich.
